...
export function NativeProfile({ uid, name, email, tier, groupMemberships, accountStateError, onRetryAccountState, onGroupTools, onAccount, onPro, onHome, onEdit, onInfo }: { uid: string; name: string; email: string; tier: string; groupMemberships: GroupToolsMembership[]; accountStateError: string; onRetryAccountState: () => void; onGroupTools: (membership: GroupToolsMembership) => void; onAccount: () => void; onPro: () => void; onHome: () => void; onEdit: () => void; onInfo: (kind: 'privacy' | 'terms' | 'refunds' | 'help') => void }) {
